      ...
      <section className="space-y-4 border border-slate-800 rounded-2xl p-4 bg-slate-900/60">
        ...
        <div className="space-y-3 mt-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-blue-600 text-slate-950　text-sm text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-500 active:bg-blue-700 transition"
          >
